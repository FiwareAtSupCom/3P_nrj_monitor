...
void ADE9000Class:: ReadAccumulatedActiveRegs(uint32_t* Data)
{
  *Data = int32_t ((SPI_Read_32(ADDR_AWATTHR_HI)) && (0x1FFFFFFF));//AWATTHR_HI goes to zero after read
	*Data = *Data<<13;
	*Data |= int32_t ((SPI_Read_32(ADDR_AWATTHR_LO)) && (0xFFF)); // 5Kwh max in 1hour
}
