...
****************************************************************************************************************/
 ...
 //////////////////////////////
 struct ActiveEnergyperH
 {
	int32_t ActiveEnergy_A;
	int32_t ActiveEnergy_B;
	int32_t ActiveEnergy_C;
 };

  struct ReactiveEnergyperH
 {
	int32_t ReactiveEnergy_A;
	int32_t ReactiveEnergy_B;
	int32_t ReactiveEnergy_C;
 };
